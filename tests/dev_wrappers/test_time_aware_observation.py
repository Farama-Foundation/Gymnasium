...
@pytest.mark.parametrize(
    "env",
    [
        gymnasium.make("CartPole-v1", disable_env_checker=True),
        gymnasium.make("CarRacing-v2", disable_env_checker=True),
        gymnasium.vector.make(
            "CartPole-v1", disable_env_checker=True, num_envs=NUM_ENVS
        ),
        gymnasium.vector.make(
            "CarRacing-v2", disable_env_checker=True, num_envs=NUM_ENVS
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        gymnasium.make("CartPole-v1", disable_env_checker=True),
        gymnasium.make("CarRacing-v2", disable_env_checker=True, continuous=False),
    ],
)
