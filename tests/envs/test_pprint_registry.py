...
def test_pprint_custom_registry():
    ...
    out = gym.pprint_registry(a, disable_print=True, test=1)
...
def test_pprint_registry():
    ...
    out = gym.pprint_registry(disable_print=True, test=2)
...
===== utils_envs =====
RegisterDuringMakeEnv-v0     test.ArgumentEnv-v0          test.OrderlessArgumentEnv-v0 

===== test =====
test/NoHuman-v0              test/NoHumanNoRGB-v0         test/NoHumanOldAPI-v0        
...
def test_pprint_registry_exclude_namespaces():
    ...
    out = gym.pprint_registry(
        num_cols=2, exclude_namespaces=["classic_control"], disable_print=True, test=3
    )

    correct_out = """===== box2d =====
BipedalWalker-v3             BipedalWalkerHardcore-v3     
CarRacing-v2                 LunarLander-v2               
...
===== utils_envs =====
RegisterDuringMakeEnv-v0     test.ArgumentEnv-v0          
test.OrderlessArgumentEnv-v0 

===== test =====
test/NoHuman-v0              test/NoHumanNoRGB-v0         
...
def test_pprint_registry_no_entry_point():
    ...
    out = gym.pprint_registry(disable_print=True, test=4)
