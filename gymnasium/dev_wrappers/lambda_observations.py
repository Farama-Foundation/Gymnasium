...
from gymnasium.dev_wrappers.utils.filter_space import filter_space
...
from gymnasium.spaces.utils import apply_function, flatten, flatten_space
...
class FilterObservationsV0(LambdaObservationsV0):
    ...
    def __init__(self, env: gymnasium.Env, args: FuncArgType[bool]):
...
class FlattenObservationsV0(LambdaObservationsV0):
    ...
    def __init__(self, env: gymnasium.Env, args: Optional[FuncArgType[bool]] = None):
...
class GrayscaleObservationsV0(LambdaObservationsV0):
    ...
    Composite Example with Multiple Box observation space:
        >>> env = gymnasium.vector.make("CarRacing-v1", num_envs=3)
        >>> env.observation_space
    ...
    def __init__(self, env: gymnasium.Env, args: FuncArgType[bool] = True):
    ...
    def _grayscale_space(self, env: gymnasium.Env, args: FuncArgType[bool]):
...
class ResizeObservationsV0(LambdaObservationsV0):
    ...
    def __init__(self, env: gymnasium.Env, args: FuncArgType[typing.Tuple[int, ...]]):
    ...
    def _resize_space(
        self, env: gymnasium.Env, args: FuncArgType[typing.Tuple[int, ...]]
    ):
...
class ReshapeObservationsV0(LambdaObservationsV0):
    ...
    def _reshape_space(
        self, env: gymnasium.Env, args: FuncArgType[typing.Tuple[int, int]]
    ):
...
class ObservationsDtypeV0(LambdaObservationsV0):
    ...
    def __init__(self, env: gymnasium.Env, args: FuncArgType[jp.dtype]):
    ...
    def _update_dtype(self, env: gymnasium.Env, args: FuncArgType[jp.dtype]):
        """Process the space and apply the transformation."""
