...
class Walker2dEnv(MujocoEnv, utils.EzPickle):
    ...
    ## Starting State
    The initial position state is {math} `[0, 1.25, 0, 0, 0, 0, 0, 0, 0] + \mathcal{U}_{[-reset\_noise\_scale \times 1_{9}, reset\_noise\_scale \times 1_{9}]}`.
    The initial velocity state is {math} `\mathcal{U}_{[-reset\_noise\_scale \times 1_{9}, reset\_noise\_scale \times 1_{9}]}`.
