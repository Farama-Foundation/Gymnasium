...
class HalfCheetahEnv(MujocoEnv, utils.EzPickle):
    ...
    | --- | ----------------------------------------- | ---- | --- | -------------------------------- | ----- | ------------------------ |
    | 0   | z-coordinate angle of the front tip       | -Inf | Inf | rootz                            | slide | position (m)             |
    | 1   | angle of the root                         | -Inf | Inf | rooty                            | hinge | angle (rad)              |
    ...
    | 8   | velocity of the x-coordinate of the root  | -Inf | Inf | rootx                            | slide | velocity (m/s)           |
    | 9   | velocity of the z-coordinate of the root  | -Inf | Inf | rootz                            | slide | velocity (m/s)           |
