...
if torch is not None:
    ...
    def _mapping_torch_to_numpy(value: Mapping[str, Any]) -> Mapping[str, Any]:
        """Converts a mapping of PyTorch Tensors into a Dictionary of numpy arrays."""
    ...
    def _iterable_torch_to_numpy(value: Iterable[Any]) -> Iterable[Any]:
        """Converts an Iterable from PyTorch Tensors to an iterable of numpy arrays."""
...
if torch is not None:
    ...
    def _numpy_mapping_to_torch(
        ...
        """Converts a mapping of numpy arrays into a Dictionary of PyTorch Tensors."""
