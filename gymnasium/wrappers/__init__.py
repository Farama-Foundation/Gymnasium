...
from gymnasium.wrappers.atari_preprocessing import (
    AtariPreprocessing as _AtariPreprocessing,
)
...
from gymnasium.wrappers.filter_observation import (
    FilterObservation as _FilterObservation,
)
from gymnasium.wrappers.flatten_observation import (
    FlattenObservation as _FlattenObservation,
)
...
from gymnasium.wrappers.gray_scale_observation import (
    GrayScaleObservation as _GrayScaleObservation,
)
...
from gymnasium.wrappers.pixel_observation import (
    PixelObservationWrapper as _PixelObservationWrapper,
)
...
from gymnasium.wrappers.record_video import (
    capped_cubic_video_schedule as _capped_cubic_video_schedule,
)
...
from gymnasium.wrappers.resize_observation import (
    ResizeObservation as _ResizeObservation,
)
from gymnasium.wrappers.step_api_compatibility import (
    StepAPICompatibility as _StepAPICompatibility,
)
from gymnasium.wrappers.time_aware_observation import (
    TimeAwareObservation as _TimeAwareObservation,
)
...
def __getattr__(name):
    logger.warn(
        "Wrappers have been replaced in favor of lambda wrappers and they will be deleted soon. "
        "Use the ones in gymnasium.experimental.wrappers, for further details see: "
    )  # TODO
